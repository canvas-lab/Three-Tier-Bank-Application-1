    ...
    public class LogHelper
    {
        ...
        public void log(string message)
        {
            try
            {
                ...
                string docPath = new FileInfo(AppDomain.CurrentDomain.BaseDirectory).Directory.Parent.Parent.Parent.FullName;
                //set txtFileName as the local text file path for the log messages
                string txtFileName = "Log-Tut2-DCAssignment2.txt";
